            ...
            <div class="row">
                <div class="col-md-12 text-center mb-4">
                    @if($psychoeducation->image)
                        <img src="{{ asset('storage/' . $psychoeducation->image) }}" alt="Image" class="rounded shadow" style="max-width: 400px;">
                    @else
                ...
                <div class="col-md-12 mb-3">
                    ...
                    @if($psychoeducation->link_yt)
                        <p class="mt-2">
                            ...
                            <a href="{{ $psychoeducation->link_yt }}" target="_blank">{{ $psychoeducation->link_yt }}</a>
                        </p>
                    @endif
                </div>
