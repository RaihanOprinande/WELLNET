                    ...
                    <div class="card-style mb-30">
                        ...
                        <div class="row align-items-center">
                            <div class="title d-flex justify-content-between">
                                ...
                                <div class="right">
                                    <a href="{{ route('user_setting.createPersonal') }}" class="main-btn btn-sm primary-btn btn-hover mb-20 me-2">
                                        <i class="lni lni-user"></i> Tambah Personal
                                    </a>
                                    <a href="{{ route('user_setting.createChildren') }}" class="main-btn btn-sm success-btn btn-hover mb-20">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @elseif ($user->role === 'parent')
                                                    @if (count($children) > 0)
                                                        @foreach ($children as $child)
                                                            <p>{{ $child->email }} <br><small class="text-muted">email orang tua: {{ $user->email }}</small></p>
                                                        @endforeach
                                                    @else
                                            ...
                                            <td>
                                                ...
                                                <form action="{{ route('user_setting.destroy', $setting->id) }}" method="POST" class="d-inline">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit"
