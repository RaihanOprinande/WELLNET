                    ...
                    <div class="card-style mb-30">
                        <div class="row align-items-center">
                            <div class="title d-flex justify-content-between">
                                ...
                                <div class="right">
                                    <button class="main-btn btn-sm primary-btn btn-hover mb-20" data-bs-toggle="modal" data-bs-target="#createModaltemaQuiz">
                        ...
                        <div class="table-responsive">
                            <table id="table" class="table" >
                                <thead>
                                    <tr>
                                        <th><h6>No</h6></th>
                                        <th><h6>Gambar Sampul</h6></th>
                                        <th><h6>Judul</h6></th>
                                        <th><h6>Topik</h6></th>
                                        <th><h6>Materi Relevan</h6></th>
                                        <th><h6>Minggu</h6></th>
                                        <th><h6>Aksi</h6></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @foreach($tema_quiz as $i => $item)
                                        <tr>
                                            ...
                                            <td><p>{{ $item->topik }}</p></td>
                                            <td><p>{{ $item->materi_relevan }}</p></td>
                                            <td><p>{{ $item->week }}</p></td>
                                            <td>
